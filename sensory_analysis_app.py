...
# ============================================================================
# 카테고리별 표준 특성 프로파일 (전문가 지침)
# ============================================================================
# 각 카테고리의 실제 시장 제품의 물성·관능 표준 범위를 정의
# Stage 1·Stage 2 프롬프트에 주입되어 AI가 카테고리 맥락으로 평가하도록 함

CATEGORY_STANDARD_PROFILES = {
    '음료': {
        'sub_types': ['탄산음료', '주스/과즙음료', '차/기능성음료', '커피음료', '유음료'],
        'physical_std': {
            'brix': '탄산음료 8~12, 주스 10~14, 차 2~8',
            'pH': '2.5~4.5 (산성)',
            'acidity': '0.05~0.3% (citric acid 환산)',
            'viscosity': '물 수준 (1~10 cP)',
        },
        'sensory_std': {
            '단맛 기준점': '리커트 4점 ≈ Brix 10 (탄산음료)',
            '산미': '2~3점 (탄산·주스는 밝은 산미 필수)',
            '쓴맛': '1~2점 (커피·차 제외 일반 음료는 거의 없음)',
            '끝맛 여운': '3~4점 (짧고 깔끔)',
        },
        'expert_guideline': (
            "음료는 '한 모금에 끝나는 첫인상'이 핵심. 단맛·산미 균형이 중요하며, "
            "뒤끝(여운)은 길지 않아야 선호됨. 탄산음료는 청량감(탄산)이 단맛 인식을 "
            "약 1점 낮추는 효과가 있어 실제 당도 대비 덜 달게 느껴짐. "
            "코카콜라(Brix 10.6)도 단맛 강도 6~7점 범위에서 시장 성공 사례임."
        ),
        'market_examples': [
            "코카콜라: Brix 10.6, pH 2.5, 단맛 강도 ≈ 6.5",
            "오렌지주스: Brix 11~12, pH 3.5, 단맛 강도 ≈ 5",
            "녹차: Brix 0.5, pH 6, 쓴맛 3~4",
        ],
    },
    '유제품': {
        'sub_types': ['우유', '요거트', '치즈', '크림', '발효유'],
        'physical_std': {
            'brix': '우유 10~14 (유당 포함), 요거트 10~16',
            'pH': '우유 6.5~6.8, 요거트 4.0~4.6',
            'fat': '무지방 0.1%, 저지방 1~2%, 일반 3.5%',
            'protein': '2.8~3.5%',
        },
        'sensory_std': {
            '단맛 기준점': '리커트 5점 ≈ 가당 요거트 수준',
            '신맛': '발효유·요거트는 3~4점이 정상',
            '유지방 풍미': '지방 3.5% 이상은 크리미함 필수',
            '끝맛 여운': '3~5점 (유지방이 길게 남음)',
        },
        'expert_guideline': (
            "유제품은 지방·단백질이 맛 인식을 크게 좌우. "
            "요거트는 신맛 3~4점이 '발효가 잘 된 상태'로 선호되며, 신맛 1점은 오히려 "
            "'발효 안 된 싱거움'으로 불호. 단맛도 가당 제품은 5~6점이 정상."
        ),
        'market_examples': [
            "서울우유: 단맛 4, 유지방 풍미 5",
            "요플레 오리지널: 단맛 5, 신맛 3.5",
            "그릭요거트(무가당): 단맛 1, 신맛 5",
        ],
    },
    '빙과': {
        'sub_types': ['아이스크림', '샤베트', '아이스바', '빙수'],
        'physical_std': {
            'brix': '아이스크림 23~30 (매우 높음!), 샤베트 25~35',
            'overrun': '아이스크림 80~120% (공기 함량)',
            'fat': '아이스크림 8~12%, 샤베트 0~2%',
            'serving_temp': '-14 ~ -18°C (저온 감각)',
        },
        'sensory_std': {
            '단맛 기준점': '리커트 6점 ≈ Brix 25 (일반 아이스크림)',
            '단맛 6점은 기본 요구 수준': '빙과는 저온에서 단맛 인식이 1~2점 낮아지므로 Brix를 높게 설계',
            '유지방 풍미': '아이스크림은 5~6점',
            '끝맛 여운': '4~5점 (진한 크리미)',
        },
        'expert_guideline': (
            "⚠️ 중요: 빙과의 단맛 인식은 저온(-14℃) 때문에 일반 음료보다 "
            "실제보다 약 1.5점 낮게 느껴짐. "
            "따라서 Brix 25 (단맛 실측 강도 6.5)도 '적정~약간 강함' 범위로 "
            "소비자가 수용함. 아이스크림 단맛 5점은 오히려 싱겁게 느껴질 수 있음. "
            "오버런(공기 함량)이 단맛을 완화하는 효과도 있음."
        ),
        'market_examples': [
            "투게더 바닐라: Brix 26, 단맛 강도 6, 유지방 풍미 5",
            "메로나: Brix 30, 단맛 강도 7, 과일 풍미 강함",
            "하겐다즈: Brix 24, 유지방 8, 진한 크림감 6",
        ],
    },
    '스낵': {
        'sub_types': ['감자칩', '과자/쿠키', '시리얼', '건과류', '전통과자'],
        'physical_std': {
            'moisture': '2~5% (바삭함 유지)',
            'salt': '감자칩 1.2~1.8%, 과자 0.3~0.8%',
            'fat': '감자칩 30~38%, 쿠키 15~25%',
            'crispness': '파쇄 강도 표준',
        },
        'sensory_std': {
            '단맛 기준점': '쿠키 5점, 감자칩 2점',
        ...
        'expert_guideline': (
            "스낵은 식감(바삭함)이 맛만큼 중요. "
            "감자칩은 짠맛 4~5점이 정상, 쿠키는 단맛 5점이 정상. "
            "짠맛·단맛의 밸런스와 감칠맛이 재구매에 결정적."
        ),
        'market_examples': [
            "오리지널 감자칩: 짠맛 4.5, 바삭함 6, 단맛 1",
            "초코칩 쿠키: 단맛 5.5, 바삭함 5, 초콜릿 풍미 5",
        ],
    },
    '베이커리': {
        'sub_types': ['식빵', '케이크', '도넛', '파이', '페이스트리'],
        'physical_std': {
            'brix': '식빵 5~8, 케이크 25~35, 도넛 18~25',
            'moisture': '식빵 35~38%, 케이크 25~30%',
            'fat': '식빵 2~5%, 케이크 15~25%',
            'gas_cell': '기공 구조 중요',
        },
        'sensory_std': {
            '단맛 기준점': '식빵 3, 케이크 5~6, 도넛 5',
            '식감(부드러움)': '5~6점',
            '버터·유지 풍미': '3~5점',
            '발효향': '식빵 3~4점',
        },
        'expert_guideline': (
            "베이커리는 제품별 단맛 기대치 편차 큼. "
            "식빵은 단맛 3점이 정상 (너무 달면 불호), "
            "케이크·도넛은 단맛 5~6점이 정상. "
            "버터/유지 풍미가 '고급감' 인식에 중요."
        ),
        'market_examples': [
            "일반 식빵: 단맛 3, 부드러움 5",
            "초코 케이크: 단맛 6, 부드러움 5.5, 코코아 풍미 5",
        ],
    },
    '주류': {
        'sub_types': ['맥주', '와인', '소주', '리큐르', '탁주'],
        'physical_std': {
            'alcohol': '맥주 4~5.5%, 소주 16~25%, 와인 12~14%',
            'brix': '맥주 2~4, 와인 6~12 (드라이~스위트)',
            'pH': '맥주 4.0~4.5, 와인 3.2~3.8',
            'IBU (맥주)': '10~40 (쓴맛 단위)',
        },
        'sensory_std': {
            '단맛 기준점': '맥주 2, 와인 3~5, 소주 1',
            '쓴맛': '맥주 3~5, IPA 5~6 (정상)',
            '알코올 감': '4~5점 (주류의 특성)',
            '끝맛 여운': '5~6점 (길수록 고급)',
        },
        'expert_guideline': (
            "주류는 쓴맛·알코올감이 '불호 요소'가 아니라 '카테고리 특성'임. "
            "맥주 쓴맛 4~5점은 정상이며, 이를 낮게 평가하면 '밍밍한 맥주'로 불호. "
            "여운(finish)이 길수록 고급주로 인식됨. 소주는 단맛·쓴맛 모두 낮고 "
            "알코올감이 지배적."
        ),
        'market_examples': [
            "카스 맥주: 쓴맛 3, 알코올 4, 단맛 1.5",
            "IPA 맥주: 쓴맛 5.5, 홉 풍미 6",
            "참이슬 소주: 단맛 1, 알코올 5, 쓴맛 2",
        ],
    },
    '기타': {
        'sub_types': ['레토르트', '조미료', '장류'],
        'physical_std': {'brix': '제품별 편차 큼', 'pH': '제품별 편차 큼'},
        'sensory_std': {'단맛 기준점': '제품 특성에 따라 판단'},
        'expert_guideline': "일반적 식품 평가 기준 적용",
        'market_examples': [],
    },
}
...
def format_category_guideline_for_prompt(category):
    """프롬프트에 주입할 카테고리 지침 문자열 생성"""
    std = get_category_standard(category)
    
    physical = "\n".join([f"  • {k}: {v}" for k, v in std['physical_std'].items()])
    sensory = "\n".join([f"  • {k}: {v}" for k, v in std['sensory_std'].items()])
    examples = "\n".join([f"  • {ex}" for ex in std['market_examples']])
    
    guideline = f"""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
**🎯 {category} 카테고리 표준 특성 (전문 패널 훈련 지침)**
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**세부 제품군**: {', '.join(std['sub_types'])}
...
**전문가 평가 지침**:
{std['expert_guideline']}

**시장 기준 제품 예시**:
{examples if examples else '  (해당 사항 없음)'}

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
**⚠️ 이 카테고리에서는**:
- 위 표준 범위 내의 강도는 '정상'으로 평가 (불호 요소 아님)
- 표준 대비 벗어난 경우만 JAR에서 경고 처리
- 페르소나는 해당 카테고리를 잘 아는 소비자임을 전제로 평가
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
    return guideline
...
모든 패널은 평가 전 다음 훈련을 받았다고 가정합니다:
1. {category} 카테고리의 **표준 강도 기준**을 체득 (위 지침 참조)
2. 시장 기준 제품들을 시음하여 '정상 범위' 감각 캘리브레이션
3. 카테고리 특성을 '불호 요소'로 오해하지 않도록 인식 훈련

따라서 페르소나가 이 카테고리를 좋아하든 싫어하든:
- 카테고리 특성상 당연한 강도는 '정상'으로 평가
- 예: 빙과의 단맛 6점은 정상 → '너무 달다'가 아닌 '카테고리 표준'으로 인식
- 예: 맥주의 쓴맛 4점은 정상 → 쓴맛 자체는 낮게 평가 안 함
- 비타겟 페르소나도 '카테고리 자체가 내 취향이 아니다'와
  '이 제품이 카테고리 표준을 못 맞췄다'를 구분해서 평가
...
"""
    ...
    if is_recipe_mode:
        ...
        # 카테고리 표준 특성 expander (신규)
        cat_std = get_category_standard(recipe_category)
        with st.expander(f"📚 {recipe_category} 카테고리 표준 특성 보기 (전문가 지침)",
                        expanded=False):
            st.markdown(f"**세부 제품군**: {', '.join(cat_std['sub_types'])}")
            
            std_col1, std_col2 = st.columns(2)
            with std_col1:
                st.markdown("**물리·화학 표준 범위**")
                for k, v in cat_std['physical_std'].items():
                    st.caption(f"• **{k}**: {v}")
            with std_col2:
                st.markdown("**관능 표준 강도 (리커트 7점)**")
                for k, v in cat_std['sensory_std'].items():
                    st.caption(f"• **{k}**: {v}")
            
            st.markdown("**🎓 전문가 평가 지침**")
            st.info(cat_std['expert_guideline'])
            
            if cat_std['market_examples']:
                st.markdown("**📊 시장 기준 제품 예시**")
                for ex in cat_std['market_examples']:
                    st.caption(f"• {ex}")
            
            st.caption(
                "ℹ️ 이 표준은 Stage 1·2 프롬프트에 주입되어 AI 패널이 "
                "카테고리 표준을 이해한 상태로 평가합니다. "
                "즉 **패널이 해당 카테고리 훈련을 받은 상태**로 조사가 진행됩니다."
            )
            ...
            if run_s1:
                with st.spinner(f"Stage 1: {recipe_category} 관점으로 이화학 계산 + 맛 추론 중..."):
                    ...
                    flavor, raw = call_claude_api_json(
                        prompt, st.session_state.api_key,
                        st.session_state.claude_model,
                        system_msg=f"당신은 20년 경력의 {recipe_category} 카테고리 전문 관능 평가자입니다.",
                        max_tokens=4000
                    )
                    if flavor:
